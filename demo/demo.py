...
* The "get_similar_pyaudio_metric" gets as input a wav file path 
  ...
  transforms them in the direction of their first 20 principal components.
...
def get_similar_pyaudio_metric(wav_path):
    ...
    pca = PCA(n_components=20) # choose first 20 principal components to get visualiation results as well
